...
const destination = path.join(root, 'public/simulators/opamp');
const scripts = [
  'embed.js',
  'sfg1013.js',
  'routing.js',
...
for (const name of ['index.html', 'styles.css', ...scripts]) {
...
await writeFile(
  path.join(destination, 'gds1202b_opamp_sim_single_file.html'),
  html,
);
console.log('Packaged Op-Amp Lab Simulator and offline HTML.');
