...
(function(root){
  ...
  function validate(d,prepareLayout,validateScope){
    ...
    if(!object(d)||d.lab!=='rc-filter'||d.version!==1||!object(d.state)||!object(d.scope))throw new Error('Unsupported RC filter save.');
    ...
    return {envelope:{lab:'rc-filter',version:1,state:board,scope:{...d.scope,frozenRecord:null,frozenFrame:null,running:true,singleArmed:false}},converted:false,relocated:0};
  }
  function schematic(kind){
    const band=kind==='bandpass',high=kind!=='lowpass';
